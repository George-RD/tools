...
const ThreeCanvasInternals = (props) => {
    ...
    return (jsx_runtime_1.jsx(SuspenseLoader_1.SuspenseLoader, { children: jsx_runtime_1.jsxs(fiber_1.Canvas, { style: actualStyle, ...rest, resize: { offsetSize: true, ...resize }, frameloop: isRendering ? 'never' : (frameloop !== null && frameloop !== void 0 ? frameloop : 'always'), onCreated: remotion_onCreated, children: [
